...
def download_track(artist, track, music_dir, yt_dlp_path):
    ...
    fpath = os.path.join(music_dir, f"{artist} - {track}.mp3")
...
def main():
    ...
    download_track(args.artist, args.track, music_dir, yt_dlp_path)
